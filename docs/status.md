...
### v1.1.2 — diagnostic report (released)
...
- Release preparation uncovered two pre-existing `1.1.1` blockers before
  ...
  Submission 3, passed certification, and was manually published to the
  Microsoft Store on September 15, 2026.
